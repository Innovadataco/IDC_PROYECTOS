# S.O.I. — SISTEMA OPERATIVO INTELIGENTE DE INNOVADATACO

**Memoria Institucional + Diagnóstico de Empresa v1.0**

**Documento generado por:** ZEUS Agente IA
**Fecha de generación:** 19 de junio de 2026
**Clasificación:** Uso interno corporativo
**Estado del documento:** Fase 0 — Diagnóstico completado
...
# PARTE III: MODELO DE OPERACIÓN AI-NATIVE
...
# PARTE IV: PORTAFOLIO DE PROYECTOS
...
# PARTE V: HABILIDADES Y CAPACIDADES DEL ECOSISTEMA
...
# PARTE VI: REGLAS OPERATIVAS CRÍTICAS
...
# PARTE VIII: HISTORIAL DE APRENDIZAJES CRÍTICOS
...
# PARTE IX: RITUALES OPERATIVOS EMPRESARIALES
...
# PARTE X: DATOS TÉCNICOS DE LA INFRAESTRUCTURA
...
# PARTE XII: HERRAMIENTAS Y SKILLS ACTIVOS
...
# PARTE XIII: S.O.I. — DIAGNÓSTICO DE EMPRESA (FASE 0)

## 13.1 ¿Qué es exactamente InnovaDataCO?

InnovaDataCO es una empresa **AI-Native** de consultoría estratégica y desarrollo tecnológico. Hace 4 cosas:

1. **Estructura proyectos de transporte público** (ITS — Sistemas Inteligentes de Transporte) para entidades como alcaldías, Ministerio de Transporte, Metro Sabanas.
2. **Desarrolla software** con componente social (ej: plataforma de protección infantil).
3. **Consultoría digital** — transformación, analítica, documentación técnica.
4. **Licitaciones y contratación pública** — acompañamiento precontractual, estudios previos, pliegos.

**Compran:** Entidades públicas (Alcaldía de Chía, MME, Metro Sabanas S.A.S.) y aliados privados (CI2/IND TECH).

**Ganan dinero:** Por consultoría estratégica ($39M–$90M COP por proyecto), desarrollo de software, y estructuración de procesos de contratación.
...
- Daniel Duarte / TransConsult — ITS operativo
- Carolina Durán (D & A Asociados) — jurídico-contractual
- CI2/IND TECH — aliado contratado (SICOM)

**Total humanos core:** 2.
**Total con contratistas:** 6–8 dependiendo del proyecto.

## 13.3 Líneas de Negocio

| # | Línea | Descripción |
|---|-------|-------------|
| 1 | **ITS (Sistemas Inteligentes de Transporte)** | Diseño conceptual, arquitectura tecnológica, especificaciones, RFI/RFQ para sistemas de transporte público |
| 2 | **Consultoría estratégica y precontractual** | Estructuración jurídica, financiera y técnica de procesos de contratación pública |
| 3 | **Desarrollo de software** | Plataformas con impacto social (protección infantil), herramientas de gobierno |
| 4 | **Transformación digital / Analítica** | Documentación técnica, síntesis institucional, inteligencia documental |
| 5 | **Asesoría en licitaciones** | Acompañamiento hasta adjudicación, defensa de ofertas, observaciones |

## 13.4 Proyectos Activos (Hoy)

| # | Código | Nombre | Cliente | Estado |
|---|--------|--------|---------|--------|
| 1 | P-001 | APP Chía-Girardot (ITS) | Alcaldía de Chía / MinTransporte | 🔴 En ejecución — urgente |
| 2 | P-002 | SICOM 2026 (Empalme MME) | CI2 / IND TECH | 🟡 En ejecución |
| 3 | P-003 | SETP Sincelejo | Metro Sabanas S.A.S. | 🟡 Propuesta enviada — esperando Carolina |
| 4 | P-005 | Protección Infantil (Semáforo de Confianza) | Interno / Social | 🟡 En correcciones post-auditoría |
| 5 | P-007 | Por definir | — | 🟡 Registrado |

## 13.5 Herramientas que Usas Hoy

| Herramienta | ¿Usas? | Nota |
|-------------|--------|------|
...
**Observación:** No tienes un PMO digital. Gestionas proyectos con GitHub + Google Drive + memoria de ZEUS. No hay un tablero visual de estados, riesgos, responsables.

## 13.6 Tu Principal Dolor

> **"La información vive en 5 lugares y no se habla entre ellos."**

Tus proyectos están en:
- GitHub (código y algunos MD)
- Google Drive (documentos fuente, contratos, PDFs)
- Conversaciones con ZEUS (contexto que se pierde entre sesiones)
- Correos de Gmail (comunicaciones con clientes)
- La cabeza de Jelkin (y no siempre le pregunta a ZEUS)

**Resultado:** Repites instrucciones. Pierdes contexto. ZEUS tiene que "adivinar" el estado. No hay un único lugar donde ver: *"¿En qué va cada proyecto? ¿Quién debe hacer qué hoy? ¿Qué se acaba de entregar? ¿Qué está bloqueado?"*

**El dolor no es tecnológico. Es de coordinación.**

---

# PARTE XIV: NOTAS FINALES Y PRÓXIMOS PASOS S.O.I.

Este documento es una **compilación viva** de la memoria institucional de InnovaDataCO y el punto de partida del S.O.I. (Sistema Operativo Inteligente).

## Fase 0: Diagnóstico — ✅ COMPLETADO

## Fase 1: Diseño — PENDIENTE

Próximos pasos del S.O.I.:
1. Definir la arquitectura de información (dónde vive qué)
2. Diseñar el flujo de trabajo entre humanos e IA
3. Establecer el sistema de memoria operativa unificado
4. Crear el dashboard de estado de proyectos
5. Automatizar la sincronización entre fuentes
